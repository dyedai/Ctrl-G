...
namespace NavKeypad
{
    public class Keypad : MonoBehaviour
    {
        ...
        {
            isLocked = true;
            UpdateDisplay(accessGrantedText);
            SetPanelColor(screenGrantedColor);
        ...
        private void AccessDenied()
        {
            UpdateDisplay(accessDeniedText);
            SetPanelColor(screenDeniedColor);
        ...
        private void ResetKeypad()
        {
            ...
            resetTimer = 0f;
            UpdateDisplay("");
            SetPanelColor(screenNormalColor);
        }
        ...
        {
            if (panelMesh != null && panelMesh.material != null)
            {
